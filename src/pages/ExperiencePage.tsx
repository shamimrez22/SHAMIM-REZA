    ...
    <div className="pt-20">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Chronological employment history, academic qualifications, Microsoft/Google certifications, and client endorsements.
          </p>
        </div>
      </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-xl font-black tracking-tight">Ready to collaborate with a verified specialist?</h3>
            <p
            ...
            >
              Let&apos;s discuss how my administrative experience and precision can elevate your team.
            </p>
          </div>
