    ...
    <div className="pt-20">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <span>/</span>
            <span className={theme === 'orange' ? 'text-amber-300/70' : 'text-slate-400'}>Services &amp; Process</span>
          </div>
          ...
          >
            High-reliability data entry solutions, spreadsheet architecture, and a 5-stage quality-guaranteed workflow.
          </p>
        </div>
      </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-xl font-black tracking-tight">Ready to streamline your business data?</h3>
            <p
            ...
            >
              Share your project scope, raw documents, or recurring administrative needs for a quick turnaround estimate.
            </p>
          </div>
