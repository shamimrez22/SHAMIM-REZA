        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service: ServiceItem, index: number) => (
            <motion.div
              ...
              className={`p-8 rounded-2xl border transition-all duration-300 flex flex-col justify-between group relative overflow-hidden ${
                theme === 'orange'
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div
                    className={`w-14 h-14 rounded-2xl border flex items-center justify-center transition-all duration-300 shadow-sm ${
                      theme === 'orange'
                ...
                {/* Title */}
                <h3
                  className={`text-xl font-black tracking-tight mb-3 transition-colors ${
                    theme === 'orange'
