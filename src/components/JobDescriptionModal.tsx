            ...
            {personalInfo.jdUrl && (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-black uppercase tracking-wider">OFFICIAL UPLOADED JOB DESCRIPTION</span>
                      <span className="px-2 py-0.2 rounded text-[9px] font-black bg-amber-500 text-slate-950">
                        DIRECT ATTACHMENT
                      </span>
                    </div>
                    <p className="text-xs font-bold mt-0.5">{personalInfo.jdFileName || 'Job_Description.pdf'}</p>
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-black uppercase tracking-wider rounded-xl bg-amber-600 hover:bg-amber-500 text-white flex items-center justify-center gap-2 shadow-md transition-all active:scale-95"
                >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-white/10 print:hidden">
              ...
              <div className="flex items-center gap-1.5 p-1 rounded-xl bg-black/20 border border-white/10 self-start sm:self-auto flex-wrap">
                ...
                >
                  ...
                  <span>Executive Report (সাজানো-গোছানো রিপোর্ট)</span>
                </button>
                <button
                  type="button"
                ...
                >
                  <FileSpreadsheet className="w-3.5 h-3.5" />
                  <span>Spreadsheet Grid (ফ্যাক্টরি শিট)</span>
                </button>
                <button
                  type="button"
